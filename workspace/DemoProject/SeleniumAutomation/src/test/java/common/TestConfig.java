...
public class TestConfig
{
	...
	public static String mercuryUrl;
	public static String magnetoUrl;
	...
	public static void SetCommonEnv()
	{
		...
		googleUrl = props.getProperty("GoogleUrl");
		mercuryUrl = props.getProperty("mercuryUrl");
		magnetoUrl = props.getProperty("magnetoUrl");
		}
		catch(Exception e)
		{
			e.printStackTrace();
